...
```
```{r,include=FALSE}
savdir <- ("./cellcount_files_HABF/inst/extdata/test_data/")
image_savdir <- ("./cellcount_files_HABF/inst/extdata/test_results/")
```
...
```{r}
images <- list.files("./cellcount_files_HABF/inst/extdata/test_images/Microcystis_F192_40x/", pattern = "tif", full.name = T)
images_names <- list.files("./cellcount_files_HABF/inst/extdata/test_images/Microcystis_F192_40x/", pattern = "tif", full.name = F)
```
...
Demo.Results$within_outlier_range<-outlier_detect()
Demo.Results
```
...
savdir <- ("./cellcount_files_HABF/inst/extdata/test_data/")
image_savdir <- ("./cellcount_files_HABF/inst/extdata/test_results/")
images <- list.files("./cellcount_files_HABF/inst/extdata/test_images/NZ_Anabena_60x/", pattern = "tif", full.name = T)
images_names <- list.files("./cellcount_files_HABF/inst/extdata/test_images/NZ_Anabena_60x/", pattern = "tif", full.name = F)
...
savdir <- ("./cellcount_files_HABF/inst/extdata/test_data/")
image_savdir <- ("./cellcount_files_HABF/inst/extdata/test_results/")
images <- list.files("./cellcount_files_HABF/inst/extdata/test_images/Shewanella_100x_DAPI/", pattern = "tif", full.name = T)
images_names <- list.files("./cellcount_files_HABF/inst/extdata/test_images/Shewanella_100x_DAPI/", pattern = "tif", full.name = F)
