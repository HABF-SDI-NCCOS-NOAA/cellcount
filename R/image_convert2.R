...
#' images. See "image_convert" regarding images with single-cells.
#'
...
#' @examples image_convert2(imagesMapped[[1]],w=10,h=10,offset=0.001,areathresh=50,tolerance=0.8,ext=1)
