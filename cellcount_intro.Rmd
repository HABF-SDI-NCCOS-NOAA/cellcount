...
***cellcount*** is an open-source R package distributed by NOAA NCCOS HAB-F on [GitHub](https://github.com/orgs/HABF-SDI-NCCOS-NOAA/repositories) and uses components in the RStudio IDE program. It is advised to use both the latest version of R and RStudio before beginning.
...
- [***EBImage***](http://bioconductor.org/packages/devel/bioc/vignettes/EBImage/inst/doc/EBImage-introduction.html)
- [***tiff***](https://www.rforge.net/tiff/)
- [***pixmap***](https://cran.r-project.org/package=pixmap)
...
"cell_density" function can be implemented, using equations from Wetzel and Likens, 1991. Generating the total amount of 
...
to utilize the ***cellcount*** tool. The following overview uses ***shiny*** apps to enter input data and run image analyses. Several packages are required to utilize these UI tools:
