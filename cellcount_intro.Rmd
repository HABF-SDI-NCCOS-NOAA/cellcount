...
```{r}
<<<<<<< HEAD
cell.den <- cell_density(cell.total, height = 203.2, width = 166.4, diameter = 2.5, images = 15,
                         filtration.area = 491, volume = 1, total.volume = 100)
=======
cell.den <- cell_density(cell.total, FOV = 0.00084, images = 10, filtration.area = 213.8, volume = 0.05, total.volume = 2)
>>>>>>> 95cda98 (Updates to markdown - NOT COMPLETED)
...
causing incorrect enumeration results.](C:\Users\Tyler.Harman\Desktop\cellcount_work\misc_\Error Images)
